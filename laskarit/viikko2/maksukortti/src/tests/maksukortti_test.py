...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortilla_pystyy_ostamaan_edullisen_lounaan_kun_saldo_on_edullisen_verran(self):
        kortti = Maksukortti(2.5)
        kortti.syo_edullisesti() # -2,5, saldo 0 eurota
        self.assertEqual(str(kortti), "Kortilla on rahaa 0.0 euroa")

    def test_kortilla_pystyy_ostamaan_maukkaan_lounaan_kun_saldo_on_maukkaan_verran(self):
