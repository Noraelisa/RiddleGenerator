...
#riddle_repository.create(Riddle("What has roots as nobody sees, is taller than trees, up, up, up it goes, and yet, never grows?", "Mountain")) # pylint: disable=line-too-longriddle_repository.create(Riddle("Thirty white horses on a red hill. First they champ,then they stamp, then they stand still.", "Teeth")) # pylint: disable=line-too-long
